...
//		prodIDs = append(prodIDs, key)
//		prodQuantities = append(prodQuantities, value)
//	}
//	query := `insert into basket_products (id, basket_id, product_id, quantity)
//                      values ($1, $2, $3, $4)`
//
//	//if _, err := b.db.Exec(context.Background(), query, uuid.New(), basketID, pq.Array(prodIDs), pq.Array(prodQuantities)); err != nil {
//	//	fmt.Println("error is while inserting to basket products", err.Error())
//	//	return err
//	//}
//	for productID, quantity := range products {
